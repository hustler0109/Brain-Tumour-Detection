...
class ControllerApiAllproducts extends Controller {
    ...
    //         error_log(print_r(file_get_contents('php://input'), true)); // Log raw input
    
    //         if (empty($this->request->post['return_action_id'])) {
    //             $json['error'] = $this->language->get('error_return_action_id');
    //         } else {
    //             $return_action_id = $this->request->post['return_action_id'];
    
    //             $return_info = $this->model_sale_return->getReturn($return_action_id);
    
    //             if ($return_info) {
    //                 $json['success'] = 'Return found';
    //                 $json['return_action_id'] = $return_info['return_action_id'];
    //                 $json['status'] = $return_info['return_status']; // or 'return_status_id' if you want the ID
    //             } else {
