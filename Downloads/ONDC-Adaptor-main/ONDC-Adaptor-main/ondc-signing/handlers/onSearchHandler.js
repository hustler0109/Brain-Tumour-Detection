                    ...
                    tags: [
                        ...
                        },
                        {
                            ...
                            list: [
                                {
                                    code: "type",
                                    // value: product.category_name || "Electronics"
                                    value: ondcCategory || "Electronics"
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            list: [
                                {
                                    code: "duration",
                                    value: product.warranty_duration || ondcConfig.warrantyDefaults.duration
                                },
                                {
                                    code: "unit",
                                    value: product.warranty_unit || ondcConfig.warrantyDefaults.unit
                                }
                            ]
                        },
                        {
                        ...
                        // {
                        //     code: "raw_features",
                        //     list: rawFeatures.length ? rawFeatures : [{ code: "note", value: "No additional details available" }]
                        //   },     
                        {
                            code: "description",
                            value: tagList
